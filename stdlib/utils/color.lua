...
-- @module Utils.Color
-- @usage local Color = require('__vtk-deep-core-mining__/stdlib/utils/color')
...
local color_list = require('__vtk-deep-core-mining__/stdlib/utils/defines/color_list')

--- @table color @{defines.color}
Color.color = require('__vtk-deep-core-mining__/stdlib/utils/defines/color')
--- @table anticolor @{defines.anticolor}
Color.anticolor = require('__vtk-deep-core-mining__/stdlib/utils/defines/anticolor')
--- @table lightcolor @{defines.lightcolor}
Color.lightcolor = require('__vtk-deep-core-mining__/stdlib/utils/defines/lightcolor')
