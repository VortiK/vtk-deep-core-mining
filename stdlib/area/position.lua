...
-- @usage local Position = require('__vtk-deep-core-mining__/stdlib/area/position')
-- @see Area.Area
-- @see Concepts.Position
-- @see defines.direction
local Position = { __class = 'Position', __index = require('__vtk-deep-core-mining__/stdlib/core') }
setmetatable(Position, Position)

local Direction = require('__vtk-deep-core-mining__/stdlib/area/direction')
local Orientation = require('__vtk-deep-core-mining__/stdlib/area/orientation')
