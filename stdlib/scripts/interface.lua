--[[
    ...
    usage:
    local interface = require(__vtk-deep-core-mining__/stdlib/scripts/interface)
...
local Changes = require('__vtk-deep-core-mining__/stdlib/event/changes')
local Player = require('__vtk-deep-core-mining__/stdlib/event/player')
local Force = require('__vtk-deep-core-mining__/stdlib/event/force')
