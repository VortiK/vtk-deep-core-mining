...
-- if DEBUG then
--   require('__vtk-deep-core-mining__/stdlib/scripts/quickstart').register_events()
-- end
-- @usage
-- --If not using stdlibs event system
-- local quickstart = require('__vtk-deep-core-mining__/stdlib/scripts/quickstart')
...
local QS = require('__vtk-deep-core-mining__/stdlib/misc/config').new(_ENV.prequire('config-quickstart') or {})
