...
-- @usage local Resource = require('__vtk-deep-core-mining__/stdlib/entity/resource')
...
local Surface = require('__vtk-deep-core-mining__/stdlib/area/surface')
local Area = require('__vtk-deep-core-mining__/stdlib/area/area')
local Tile = require('__vtk-deep-core-mining__/stdlib/area/tile')
local Queue = require('__vtk-deep-core-mining__/stdlib/misc/queue')
