...
require('__vtk-deep-core-mining__/stdlib/core') -- Calling core up here to setup any required global stuffs
...
local groups = require('__vtk-deep-core-mining__/stdlib/data/modules/groups')

local Data = {
    __class = 'Data',
    __index = require('__vtk-deep-core-mining__/stdlib/core'),
    Sprites = require('__vtk-deep-core-mining__/stdlib/data/modules/sprites'),
    Pipes = require('__vtk-deep-core-mining__/stdlib/data/modules/pipes'),
    Util = require('__vtk-deep-core-mining__/stdlib/data/modules/util'),
    _default_options = {
