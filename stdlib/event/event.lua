...
-- </blockquote>
-- @module Event.Event
-- @usage local Event = require('__vtk-deep-core-mining__/stdlib/event/event')
...
local Event = {
    ...
    Filters = require('__vtk-deep-core-mining__/stdlib/event/modules/event_filters'),
...
local Type = require('__vtk-deep-core-mining__/stdlib/utils/type')
...
function Event.register_player(bool)
    require('__vtk-deep-core-mining__/stdlib/event/player').register_events(bool)
    return Event
end

function Event.register_force(bool)
    require('__vtk-deep-core-mining__/stdlib/event/force').register_events(bool)
    return Event
end

function Event.register_surface(bool)
    require('__vtk-deep-core-mining__/stdlib/event/surface').register_events(bool)
    return Event
end
...
Event.dump_data = require('__vtk-deep-core-mining__/stdlib/event/modules/dump_event_data')(Event, valid_event_id, id_to_name)
